...
UserAttendanceSchema.methods.updateWeeklyAttendance = async function(weekNumber, attendanceData) {
    const weekIndex = this.weeklyAttendance.findIndex(week => week.weekNumber === weekNumber);
...
UserAttendanceSchema.methods.getWeeklyAttendance = function(weekNumber) {
    return this.weeklyAttendance.find(week => week.weekNumber === weekNumber) || null;
};
...
const UserAttendanceModel = mongoose.model('UserAttendance', UserAttendanceSchema, 'UserAttendance'); // Fixed the typo
