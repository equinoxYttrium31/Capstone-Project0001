...
import { search_ic, filter_ic, user_placeholder, add_ic, archived_ic, close_ic } from '../../assets/Images';
...
function Record_Monitoring() {
  ...
  const confirmAddingRecord = async () => {
    const { firstName, lastName, email, password, confirmPassword, birthDate } = data;
  ...
  const handleCloseAddModal = () => { 
    ...
    const filterRecords = (query) => {
        return records.filter(record => {
            ...
            const matchesGenderFilter = selectedGender ? record.gender === selectedGender : true;
        ...
        <div className='record_monitoring_mainCont'>
            <div className="record_upper_part">
                ...
                <div className="search_record">
                    ...
                    <img src={filter_ic} alt="filter_icon" className="filter_record_icon" onClick={toggleFilter} />
                </div>
            </div>
            <div className="record_lower_part">
                ...
                <div className="record_lower_part_right">
                    <div className="selection_container_record" onClick={setAddModalActive}>
                        <img src={add_ic} alt="add_record_ic" className="selection_icon" />
                        <h2 className="selection_title">Create New Record</h2>
                    </div>
                    <div className="selection_container_record" onClick={setCellGroupModal}>
                ...
                <div className="filter_modal">
                    <div className="filter_Modal_Container">
                        ...
                        <div className="middle_container">
                            <p className="filter_text">Use filters to make it easier to find accounts.</p>
                        ...
                        <div className="lower_container">
                            <div className="buttons_cont_filter">
                                <button className='clear_filter_button' onClick={handleClearButton}>Clear</button>
                                <button className='apply_filter_button' onClick={handleApplyFilters}>Apply</button>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          <div className="newUserModal">
              <div className="mainAdding_container">
                  <div className="header_part_add">
                    ...
                    <img src={close_ic} alt="exit_button" className="add_close_button" onClick={handleCloseAddModal}/>
                  </div>
                  <div className="main_add_cntr">
                    <p className="reminder_before_adding">Remind the user to edit their user information after being added.</p>
                    <div className="adding_cont">
                        <h2 className="personal_header_adding">Personal Details</h2>
                        <div className="rows_adding_cont">
                          <input 
                            type="text" 
                            className='first_Name'name='firstName'
                            placeholder=''
                        ...
                        <div className="rows_adding_cont">
                          <input 
                            type="text" 
                            className='last_Name' name='lastName'
                            placeholder=''
                        ...
                        <div className="rows_adding_cont">
                          <input 
                            type="date" 
                            className='birth_Date' name='birthDate'
                            placeholder=''
                            value={data.birthDate} onChange={handleChange}
                            required/>
                        ...
                        <div className="rows_adding_cont">
                          <input 
                            type="email" 
                            className='email_Address' name='email'
                            placeholder=''
                        ...
                        <div className="rows_adding_cont">
                          <input 
                            type="password" 
                            className='password_Init' name='password'
                            placeholder=''
                        ...
                        <div className="rows_adding_cont">
                          <input 
                            type="password" 
                            className='password_Conf' name='confirmPassword'
                            placeholder=''
                    ...
                    <div className="adding_buttons_container">
                      <div className="row_adding_buttons_container">
                        <button className="add_new_record" onClick={handleAddingRecord}>Add New Record</button>
                      </div>
                    </div>
                  </div>
              </div>
        ...
        {confirmationModal && (
              <div className="confirmation-modal">
                  <div className="confirmation-modal-content">
                      ...
                      <p className='confirmation-modal-p'>Do you want to proceed with this action?</p>
                      <div className="confirmation-modal-buttons">
                          <button className="confirmation-confirm-button" onClick={handleConfirm}>Confirm</button>
                          <button className="confirmation-cancel-button" onClick={handleCancel}>Cancel</button>
                      </div>
                  </div>
              </div>
          )}
            ...
            <div className="create_cellgroup_cont">
                <div className="cellgroup_main_cont">
                    <div className="cellgroup_header_cont">
                        ...
                        <img src={close_ic} alt="close_icon" 
                    ...
                    <div className="create_cellgroup_main_cont">
                        ...
                        <div className="cellgroup_form_cont">
                            ...
                            <div className="cellgroup_create_btn">
                                <button className="create_cellgroup_btn">Create Cellgroup</button>
                            </div>
                        </div>
                    </div>
