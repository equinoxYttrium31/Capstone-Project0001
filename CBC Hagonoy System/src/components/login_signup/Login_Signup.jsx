      ...
      {type === 'login' && (
        <div className="login_container">
          <div className="img_holder">
            <img src={bck_btn} alt="Back" className="backbutton" onClick={onClose} />
            <img src={Login_Signup_bg} alt="Login Background" className="login_img" />
          </div>
              ...
              <form onSubmit={handleLogin}>
                ...
                <div className="checkboxes-container">
                  ...
                  <div className="checkbox-item">
                    ...
                    <label htmlFor="keepLoggedIn" className="checkfield_label">Keep me logged in</label>
                  </div>
                </div>
        ...
        <div className="signup_container">
          <div className='registration_field'>
            <div className="reg_back_btn_cont">
              <img src={bck_btn} alt="Back" className="reg_backbutton" onClick={onClose} />
            </div>
            <div className="input_fields">
              ...
              <form onSubmit={handleSignup}>
                ...
                <div className="checkbox_holder">
                  <input type='checkbox' className='checkbox-input' id='agreement' required />
                  <label htmlFor='agreement' className='agreement_label'>I agree to the Privacy Policy and Terms of Service Agreement</label>
                </div>
          ...
          <div className="img_holder_signup">
            <img src={Login_Signup_bg} alt="Signup Background" className="signup_img" />
          </div>
        </div>
      )}
    </div>
