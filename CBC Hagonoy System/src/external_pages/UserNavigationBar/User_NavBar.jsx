    ...
    <div className='nav_bar_cont'>
      <div className="main_cont_nav">
        <div className="left_side_nav">
          <img src={cbc_logo} alt="cbc_logo" className="user_nav_logo" onClick={handleModalClose} />
        </div>
        <div className="right_side_nav">
          <div className="user_nav_links">
            <ul className="user_nav_links_contents">
              ...
              <li className={isActive("/about")} onClick={() => handleModalOpen(<AboutUs />)}>About Us</li>
              <li className={isActive("/beliefs")} onClick={() => handleModalOpen(<Beliefs />)}>Beliefs</li>
              <li className={isActive("/ministries")} onClick={() => handleModalOpen(<div>Ministerial</div>)}>Ministerial</li>
              <li className={isActive("/bible")} onClick={() => handleModalOpen(<BiblePage />)}>Bible</li>
            </ul>
          </div>
