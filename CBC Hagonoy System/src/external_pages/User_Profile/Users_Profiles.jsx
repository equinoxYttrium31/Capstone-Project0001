...
function Users_Profiles({ setProfileRefresh }) {
  ...
  const handleImageUpload = async () => {
    if (uploadedImage) {
      ...
      try {
        await axios.post(
          "https://capstone-project0001-2.onrender.com/uploadProfilePic",
          { image: base64Image },
          {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      if (isFirstEdit) {
        await axios.post(
          "https://capstone-project0001-2.onrender.com/profile/initial-edit",
          updatedUser,
          {
            withCredentials: true,
            headers: {
        ...
        await axios.put(
          "https://capstone-project0001-2.onrender.com/profile/update",
          updatedUser,
          {
            withCredentials: true,
            headers: {
    ...
    <div className="User_Profile_mainCont">
      ...
      <div className="right_side_userProf_cont">
        <div className="right_side_detail">
          <h2 className="additional_info_user_header">
          ...
          <div className="contact_info_container_personal">
            <h3 className="contact_info_label_personal">
              Contact Information:
            </h3>
          ...
          <div className="user_prof_button_container">
            {isEditing && ( // Show the save button only in edit mode
              <>
                ...
                <button
                  className="Cancel_changes_button"
